...
do
    ...
    do
      # Train 
       python run_textclass.py --model_name_or_path $j --do_train  --do_eval --do_predict --train_file data/${i}_train.tsv --val_file data/${i}_dev_new.tsv --pred_file data/${i}_dev.tsv --per_device_train_batch_size 32 --learning_rate 5e-5 --num_train_epochs 3.0 --max_seq_length 128 --data_dir SubtaskA/$i --output_dir $j-$i-sentiment  --save_steps -1 --overwrite_output_dir
